...
import { Activity, ArrowLeft, BookOpen, Compass, DoorOpen, Sparkles, TrendingUp } from "lucide-react";
...
export default function CreditQuickJourney({ onComplete, onSkipToDashboard }: Props) {
  ...
  const next = useCallback(() => {
    if (step === 0) {
      trackToolEvent(CREDIT_SCORE_SLUG, "journey_start", undefined, true);
    }
          ...
          >
            <div className="relative text-center">
              <div className="relative mx-auto mb-8 flex h-36 w-36 items-center justify-center sm:h-44 sm:w-44">
                <div className="absolute -inset-6 rounded-full bg-gradient-to-br from-violet-400/30 via-indigo-400/15 to-zinc-400/20 blur-2xl dark:from-violet-500/20 dark:via-indigo-500/10" />
                ...
                <div className="relative flex h-full w-full flex-col items-center justify-center gap-2 rounded-[2rem] border border-zinc-200/90 bg-white/95 shadow-2xl ring-1 ring-violet-900/5 backdrop-blur-sm dark:border-zinc-700 dark:bg-zinc-950/95 dark:ring-violet-400/10">
                  <Activity className="h-16 w-16 text-violet-700 dark:text-violet-400" strokeWidth={1.2} aria-hidden />
                </div>
              </div>
          ...
          >
            <div className="space-y-6">
              ...
              <input
                ...
                aria-label="Revolving utilization percent"
          ...
          >
            <div className="space-y-6">
              ...
              <input
                ...
                aria-label="On-time payment percent"
                className="w-full h-3 accent-zinc-900 dark:accent-zinc-100 rounded-full"
              />
            </div>
          </WizardSlideShell>
          ...
          >
            <div className="space-y-6">
              ...
              <input
                ...
                aria-label="Average age of accounts in years"
                className="w-full h-3 accent-zinc-900 dark:accent-zinc-100 rounded-full"
              />
            </div>
          </WizardSlideShell>
            ...
            <div className="space-y-8">
              <div>
                ...
                <input
                  ...
                  aria-label="Hard inquiries in last 12 months"
                  className="w-full h-3 accent-zinc-900 dark:accent-zinc-100 rounded-full"
                />
              </div>
              <div>
