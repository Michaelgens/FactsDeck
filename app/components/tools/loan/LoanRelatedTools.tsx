...
import type { RelatedTool } from "./compute-loan-journey-metrics";

export default function LoanRelatedTools({ tools }: { tools: RelatedTool[] }) {
  ...
  return (
    <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/40">
      ...
      <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Based on your goal, rate, and principal.</p>
