    ...
    <div className="flex min-h-[60vh] flex-1 flex-col items-center justify-center bg-white px-4 py-12 dark:bg-zinc-950">
      <div className={`w-full max-w-md p-8 text-center md:p-10 ${cardSurface}`}>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap">
          <Link
            href="/"
            className="inline-flex gap-2 h-12 items-center justify-center rounded-xl bg-zinc-900 px-6 text-sm font-semibold text-white shadow-lg shadow-zinc-900/10 transition hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:shadow-white/5 dark:hover:bg-zinc-100"
          >
